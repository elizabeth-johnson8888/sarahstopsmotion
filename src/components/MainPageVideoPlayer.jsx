...
import { ParagraphTextBox } from "./Text";
 ...
 */
export function MainPageVideoPlayer({ videoClassName = "w-full max-w-5xl", videoSrc, caption }) {
...
*/ }
  return (
    <div className={videoClassName}>
        {/* caption */}
        <ParagraphTextBox text={caption} color="text-primary" />
        ...
        >
            ...
            <div className={`absolute inset-0 z-20 flex items-center justify-center bg-black/50  ${showControls ? "opacity-100" : "opacity-0 pointer-events-none"}`}>
            <button
                onClick={togglePlay}
